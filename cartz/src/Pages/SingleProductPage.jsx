...
export default function Simple() {
  ...
  const addToCart = () => {
    ...
    cartData.forEach((el, i) => {
      if (
        el.id === singleProduct.id &&
        el.category === singleProduct.category
      ) {
        duplicateData = true;
      }
    });
            ...
            >
              <Box spacing={{ base: 2, sm: 4 }}>
                ...
                <Text fontSize={"md"} mt={3} textAlign={"left"}>
                  Step into the world of {category}'s fashion and explore our
                  exceptional collection of clothing designed exclusively for
                  the modern gentleman. From sophisticated suits to casual
                  everyday essentials, our range of men's clothing encompasses
                  style, comfort, and versatility.
                  <br />
                  For colder days, indulge in our selection of cozy sweaters,
                  jackets, and coats that combine warmth with fashion-forward
                  design. From classic pea coats to trendy leather jackets, we
                  have you covered for all seasons and occasions.
                  <br />
                </Text>
              </Box>
              <Box>
